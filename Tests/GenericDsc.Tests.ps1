<# 
	Generic Tests for all DSC resources.
	Borrowed heavily from Mathieu Buisson's DSC testing boilerplate (https://github.com/MathieuBuisson)
#>

$Modules = Get-ChildItem "$PSScriptRoot\..\DSCResources\" -Filter '*.psm1' -Recurse
